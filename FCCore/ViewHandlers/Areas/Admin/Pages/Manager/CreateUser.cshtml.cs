...
namespace FCCore.Areas.Admin.Pages.Manager
{
    [AuthorizeCustomize(RoleName.Admin)]
    public class CreateUserModel(UserManager<User> userManager, DatabaseContext context, IConfiguration configuration, ILogger logger) : IChangePageModel(context, configuration)
    {
