...
namespace FCCore.Areas.Client.Pages.Registrations
{
    [AuthorizeCustomize(RoleName.Client)]
    public class CreateModel(UserManager<User>? userManager, IWebHostEnvironment environment, ILogger logger, DatabaseContext context, IConfiguration configuration, IEmailSender iEmailSender) : IWritePageModel<Registration>(userManager, environment, context, configuration)
    {
